    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
              <!--/ Intro Single star /-->
  <section class="intro-single" style="padding: 2rem 0 2rem;">
    <div class="container">
      <div class="row">
                  ...
                  <div class="card-overlay card-overlay-hover">
                    <div class="card-header-d">
                      <div class="card-title-d align-self-center">
                        <h3 class="title-d">
                          <a href="{{ route('agents-edit', $agent->id) }}" class="link-two">{{ $agent->first_name }} {{ $agent->last_name }}</a>
                        </h3>
                      </div>
                    </div>
                    <div class="card-body-d">
                      ...
                      <div class="info-agents color-a">
                        <p>
                          <strong>Mobile: </strong> {{ $agent->mobile }}</p>
                        <p>
                          <strong>Email: </strong> {{ $agent->email }}</p>
                        <p>
                          <strong>Role: </strong> {{ $agent->role }}</p>
                      </div>
                    </div>
